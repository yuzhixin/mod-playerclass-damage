...
public:
    ...
    void ModifyHealReceived(Unit* /*target*/, Unit* healer, uint32& heal, SpellInfo const* spellInfo) override
    {
        ...
        if (!PlayerClassDamageEnabled || !healer || !healer->ToPlayer() || !PlayerClassDamageRate[healer->getClass()])
            return;
    ...
    void OnAuraApply(Unit* target, Aura* aura) override
    {
		...
		if (!caster || !caster->ToPlayer() || !PlayerClassDamageRate[caster->getClass()])
            return;
    ...
    void ModifyMeleeDamage(Unit* /*target*/, Unit* attacker, uint32& damage) override
    {
        ...
        if (!PlayerClassDamageEnabled || !attacker || !attacker->ToPlayer() || !PlayerClassDamageRate[attacker->getClass()])
            return;
    ...
    void ModifySpellDamageTaken(Unit* /*target*/, Unit* attacker, int32& damage, SpellInfo const* spellInfo) override
    {
        ...
        if (!PlayerClassDamageEnabled || !attacker || !attacker->ToPlayer() or !PlayerClassDamageRate[attacker->getClass()])
            return;
